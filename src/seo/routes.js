...
const personJsonLd = {
  ...
  jobTitle:
    'מתמודד לתפקיד יושב ראש הוועדה האתית-משפטית של מועצת התלמידים והנוער הארצית',
  sameAs: SOCIAL_LINKS,
};
...
export const routes = [
  {
    path: "/",
    component: Home,
    title: "תומי דניאלי – מתמודד לתפקיד יושב ראש הוועדה האתית-משפטית",
    description:
      'תומי דניאלי, מתמודד לתפקיד יושב ראש הוועדה האתית-משפטית של מועצת התלמידים והנוער הארצית. תוכנית עבודה מלאה לוועדה, לחינוך, לתקנון ולמורחבת.',
    image: DEFAULT_IMAGE,
    jsonLd: personJsonLd,
    priority: 1.0,
  },
  {
    ...
    title: "קצת עליי",
    description:
      'תומי דניאלי מהוד השרון: מיו"ר מועצת תלמידים בבית הספר ועד ההתמודדות על תפקיד יושב ראש הוועדה האתית-משפטית הארצית – הדרך והמסע האישי אל המועמדות.',
    priority: 0.8,
  },
  {
    path: "/plans",
