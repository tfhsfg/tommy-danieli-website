    ...
    <section className="lawPageContainer almoni">
      ...
      <div className="eduSection lawPlanSection">
        ...
        <h3 style={{ maxWidth: "850px", margin: "0 auto 30px", fontSize: "16px", lineHeight: "1.6", color: "var(--text)" }}>
          ...
          הכוח האמיתי של המועצות מגיע מהלגיטימציה והאמון של התלמידים בשטח. אנחנו נחוקק את המועצה, אך במקביל נחזק את המחוזות, הרשויות ובתי הספר כדי לוודא שברגע האמת כולנו עומדים כאיש אחד.
        </h3>
