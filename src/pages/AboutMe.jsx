...
const milestones = [
  {
    ...
    title: "הצעד הראשון",
    images: [
      "/images/30KProject1.jpeg",
      "/images/30KProject2.jpeg",
      "/images/30KProject3.jpeg"
    ],
    details: `### התפקיד והשטח
כבר בהגעתי לחטיבה נבחרתי לייצג את הכיתה שלי במועצת התלמידים הבית-ספרית. בתוך זמן קצר, מצאתי את עצמי מתמודד על תפקיד היושב ראש – ומנצח תלמידים שגדולים ומנוסים ממני.
...
הובלתי פרויקט דגל להקמת גינה קהילתית בבית הספר, שכלל תוכנית פדגוגית לשיעורי טבע ותרומת תוצרת. כחלק מהמהלך, הובלתי פגישה רשמית מול ראש העירייה וצמרת אגף החינוך; למרות האתגרים והספקות בשל גילי הצעיר, הוכחנו רצינות רבה ושכנענו את העירייה להשקיע כ-30,000 ש"ח במיזם.`,
  ...
  },
  {
    ...
    images: [
      "/images/Elected1.jpeg",
      "/images/NewLimit2.jpeg",
    ],
...
במקום לעסוק רק בכיבוי שריפות, בחרתי לשים דגש רב על תהליכי תקינות באותה השנה. קיימנו בחירות תקניות לחלוטין, הובלנו כתיבה ואישור דמוקרטי של תקנון חדש לפי הדרישות, והעברנו את המועצה לעבודה מדויקת לפי המודל הארגוני הרשמי של מועצות התלמידים והנוער.

### מחוברים לשטח
במקביל, עבדנו קשה כדי להיות הכי מחוברים לשטח שאפשר. פתחנו עמוד אינסטגרם וקבוצת וואטסאפ ייעודית שהגיעה לתפוצה חסרת תקדים של כ-70% מכלל תלמידי בית הספר. דרך הערוצים האלו הרצנו סקרי שביעות רצון ואספנו רעיונות מהתלמידים באופן קבוע, כדי לוודא שהקול של כולם נשמע ומיוצג.`,
    shift: -330,
  },
  {
    id: 3,
    ...
    title: "רף חדש",
    images: [
      "/images/Newlimit1.png",
      "/images/NewLimit3.png"
    ],
...
המבוגרים, שהיה קשה לעבוד מולם בהתחלה, כבר התרגלו למנהיגות הנוער שהתייצבה בפניהם. הפכנו לשותפים מלאים עם פגישות קבועות אחת לחודש ומעורבות ישירה בכל החלטה. בשנה הזו פשוט הצבנו רף חדש לחלוטין ממה שהכירו לפני בבית הספר (ובעיר).`,
    shift: 350,
  },
  {
    id: 4,
    ...
    title: "מתחילים מאפס",
    images: [
      "/images/FreshStart1.png",
      "/images/FreshStart2.png",
      "/images/FreshStart3.jpeg"
    ],
    details: `במהלך החופש הגדול, קבעתי שוב פגישות עם בכירים בעירייה כדי לוודא שהפעם המועצה העירונית תוקם ולמרות ההבטחות של המערכת, שנת הלימודים נפתחה ושוב מצאנו אתעצמינו ללא מועצה מתפקדת. סירבתי לוותר – קבעתי פגישה דחופה עם ראש העירייה, הצגתי לו את עקרונות המועצה ולמה הנוער חייב גוף מייצג. בזכות העקשנות הזו, המועצה העירונית של הוד השרון יצאה לדרך באופן רשמי.
...
ההתחלה שלי בתפקיד הייתה מורכבת מאוד – הגענו כמות מעטה של נציגים ממספר מצומצם של בתי ספר. אבל לאורך השנה הובלנו תהליך עומק אמיתי: דאגנו להניע תהליכי בחירות רשמיים בתוך בתי הספר, גייסנו נציגים מתנועות הנוער השונות בעיר, וקיימנו לראשונה בחירות דמוקרטיות למזכירות המועצה ולנציגים המחוזיים. הפכנו מרעיון על הנייר לגוף מתפקד, חזק ומייצג.`,
  ...
  },
  {
    ...
    details: `בכיתה י״א הגשמתי חלום ונבחרתי לכהן כיו״ר הוועדה האתית-משפטית במועצת התלמידים והנוער של מחוז מרכז. במהלך השנה שמתי דגש והובלנו תהליך עומק מקיף כמחוז: פיתחנו תבנית תקנון מובנית, נגישה וקלה ליישום, שאיפשרה לרשויות ולבתי הספר לעבור תהליך הסדרה מהיר ולהביא לאישור המליאות שלהם תקנונים מעודכנים. בזכות העבודה הסיזיפית והיומיומית הזו הגענו לנתוני הצלחה חסרי תקדים בתחום התקינות במחוז – הרוב המוחלט של המועצות במחוז קיימו הליך בחירות דמוקרטי מלא ואישרו תקנון מועצה בצורה תקינה למהדרין.`,
    shift: 330,
  },
];
        ...
        <div className="aboutMainFlex">
          ...
          <div className="aboutGallery">
            <div className="galleryItem">
              <img src="/images/MeMoaztz.jpeg" alt="תומי דניאלי - עשייה במועצות" />
            </div>
            <div className="galleryItem">
              <img src="/images/Music.jpeg" alt="תומי דניאלי - מגמת מוזיקה" />
            </div>
            <div className="galleryItem">
          ...
          <div className="bodyText">
            <p className="introParagraph">היי, אני תומי,</p>
