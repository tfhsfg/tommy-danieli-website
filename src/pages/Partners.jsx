import { Link } from "react-router-dom"; // ייבוא הלינק לניווט
...
const partners = [
  ...
  {
    name: "מליאת המועצה",
    description: "לבסוף, הקשר שלי עם המליאה – הריבון של הארגון – יתבסס על שקיפות מוחלטת, ייצוגיות ומעורבות גבוהה. אדאג שחברי המליאה יבינו לעומק את תהליכי העבודה המשפטיים והאתיים, יהיו שותפים מלאים לקבלת ההחלטות ויקבלו את כל הכלים הנדרשים להצלחתם.",
    logo: "",
  },
];
...
export default function Partners() {
  return (
    <section className="partnersPage almoni" dir="rtl">
      ...
      {/* כפתור ניווט חזרה - לכל התוכניות */}
      <div className="readMoreContainer" style={{ marginTop: "40px" }}>
