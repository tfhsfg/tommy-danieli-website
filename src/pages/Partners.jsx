...
const partners = [
  ...
  {
    name: "מליאת המועצה",
    description: "לבסוף, הקשר שלי עם המליאה – הריבון של הארגון – יתבסס על שקיפות מוחלטת, ייצוגיות ומעורבות גבוהה. אדאג שחברי המליאה יבינו לעומק את תהליכי העבודה המשפטיים והאתיים, יהיו שותפים מלאים לקבלת ההחלטות ויקבלו את כל הכלים الנדרשים להצלחתם.",
    logo: "",
  },
];
