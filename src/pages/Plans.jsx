...
const planItems = [
  {
    ...
    description: "המועצה היא הפרלמנט הסטטוטורי הנבחר של מאות אלפי בני נוער. נטמיע שפה ארגונית אחידה, מקצועית וחזקה בכל הגלגלים, מבית הספר ועד הארצי, שתעניק לכל מועצה לגיטימציה מול השלטון המקומי וגיבוי מלא לנציג הבודד בשטח.",
  ...
  },
  {
    ...
    description: "שמירה על זכויותיהם של מאות אלפי התלמידים ובני הנוער בישראל בכל מסגרות החינוך והקהילה. ננגיש את הכלים המשפטיים והאתיים לנציגי הקצה, נספק רשת ביטחון ארגונית מפני מידור והשתקה, ונעמוד איתן כנגד כל פגיעה בחופש הביטוי והייצוג של הנוער.",
    to: "/rights"
  },
  {
    id: 8,
    ...
    description: "לצד הובלת הוועדה האתית-משפטית, כחבר מזכירות מצומצמת אהיה שותף מלא לניהול השוטף של המועצה הארצית. אפעל לקידום החלטות רוחביות, אקח אחריות על הובלת אירועי שיא, ואהווה אוזן קשבת וגב חזק לכל חברי המזכירות והנציגים למען הצלחת המועצה כולה.",
